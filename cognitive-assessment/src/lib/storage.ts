...
// We snapshot the played sets here so the results page and report can review them later.
...
export function getSessionSets(id: string): QuestionSet[] | null {
